...
// where the cell value is less than or equial to (but not greater than $limit )
 // return array - Column / row id    where  value <= $limit
    ...
    */
    ...
    public static function RowStatisticsNames()
    {
        $result = array();
        ...
        $result[] = 'value_count';
        $result[] = 'null_count';
        $result[] = 'value_count_percent';
        $result[] = 'value_nullvalue_ratio';
        $result[] = 'min';
        $result[] = 'max';
        $result[] = 'range';
        $result[] = 'median';
    ...
    */
    public static function RowStatistics($src,$nullValue = null)
    {
        ...
        foreach ($src as $rowID => $row)
        {
            ...
            {
                $result[$rowID]['average'] = $result[$rowID]['sum'] / $result[$rowID]['value_count'];
